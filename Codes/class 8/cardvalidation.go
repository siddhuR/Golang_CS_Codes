...
Example 1: valid credit card number4539 3195 0343 6467
...
Example 2: invalid credit card number8273 1232 7352 0569
...
func IsValid(number int) bool {
	/*
		string should be more than 1 in he length
			loop from the digit towards the start:
