...
needLicense := NeedsLicense("car") // Output: true needLicense = NeedsLicense("bike") // Output: false 2. Choose between two potential vehicles to buy
...
vehicle := ChooseVehicle("Wuling Hongguang", "Toyota Corolla") // Output: "Toyota Corolla is clearly the better choice." ChooseVehicle("Volkswagen Beetle", "Volkswagen Golf") // Output: "Volkswagen Beetle is clearly the better choice." 3. Calculate an estimation for the price of a used vehicle
...
CalculateResellPrice(1000, 1) // Output: 800 CalculateResellPrice(1000, 5) // Output: 700 CalculateResellPrice(1000, 15) // Output: 500
